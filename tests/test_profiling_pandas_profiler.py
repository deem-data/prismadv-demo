...
def test_pandas_csv_profiler_profiles_dataset(tmp_path):
    pd = pytest.importorskip("pandas")

    from prismadv.api.v1.schemas import ColumnType, InferredType
    from prismadv.profiling import PandasCSVProfiler, ProfileConfig
